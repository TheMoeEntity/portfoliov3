                    ...
                    <div className={styles.details}>
                        <div>
                            ...
                            <p>
                                ...
                                Armed with determination and a cup of lukewarm tea (courtesy of yours truly), my brother inundated me with a deluge of HTML and CSS tutorials. And let me tell you, it was like diving headfirst into the deep end of the coding pool. At first, the waters were murky, and the waves of information threatened to overwhelm me. <br /> <br />
